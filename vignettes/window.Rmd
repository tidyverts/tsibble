...
pedestrian_mth %>% 
  ...
  # (2)
  mutate(Monthly_MA = slide_dbl(data, 
    ~ mean(.$Count, na.rm = TRUE), .size = 3, .align = "center", .flatten = TRUE
  ))
```
