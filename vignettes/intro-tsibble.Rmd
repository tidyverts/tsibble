...
The key is not constrained to a single variable, but expressive of nested and crossed data structures [@wilkinson2006grammar]. A built-in dataset `tourism` contains the quarterly overnight trips from 1998 Q1 to 2016 Q4 across Australia.
