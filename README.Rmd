...
Tsibble also serves as a natural input for forecasting and many other downstream analytical tasks, for example the [fable](http://fable.tidyverts.org) package.
