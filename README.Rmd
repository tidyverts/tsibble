...
[![R build status](https://github.com/tidyverts/tsibble/workflows/R-CMD-check/badge.svg)](https://github.com/tidyverts/tsibble)
...
An ecosystem, [the tidyver*ts*](http://tidyverts.org), is built around the tsibble object for tidy time series analysis.
