...
`fill_na()` also handles filling time gaps by values or functions, and respects time zones for date-times. Wanna a quick overview of implicit time gaps? Check out [`vignette("implicit-na")`](http://pkg.earo.me/tsibble/articles/implicit-na.html).
