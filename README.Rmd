...
* **dplyr:** `arrange()`, `filter()`, `slice()`, `mutate()`, `transmute()` `r emo::ji("no_entry_sign")`, `select()`, `rename()`, `summarise()`/`summarize()`, `disintct()` `r emo::ji("no_entry_sign")`, `*_join()`, `group_by()`, `ungroup()`, `do()`
* **tidyr:** `fill()`
