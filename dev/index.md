...
[`package?tsibble`](https://tsibble.tidyverts.org/dev/reference/tsibble-package.md)
and
...
[`index_by()`](https://tsibble.tidyverts.org/dev/reference/index-by.md)
goes hand in hand with the index functions including
...
[`index_by()`](https://tsibble.tidyverts.org/dev/reference/index-by.md)
will take care of updating the key and index respectively. This
[`index_by()`](https://tsibble.tidyverts.org/dev/reference/index-by.md) +
[`summarise()`](https://dplyr.tidyverse.org/reference/summarise.html)
