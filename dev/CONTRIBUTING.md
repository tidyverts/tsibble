# Contributing to tsibble

This outlines how to propose a change to tsibble. For more detailed info
...
Conduct](https://tsibble.tidyverts.org/dev/CODE_OF_CONDUCT.md). By
