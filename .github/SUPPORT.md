# Getting help with tsibble

Thanks for using tsibble. Before filing an issue, there are a few places
...
Before opening a new issue, be sure to [search issues and pull requests](https://github.com/tidyverse/tsibble/issues) to make sure the 
